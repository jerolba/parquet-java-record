...
public class FromInt64ToShortConverter extends PrimitiveConverter {

    private final ReadReflection.ConstructorParams constructor;
    private final int idx;

    public FromInt64ToShortConverter(ReadReflection.ConstructorParams constructor, int idx) {
